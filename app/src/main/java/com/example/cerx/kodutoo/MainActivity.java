package com.example.cerx.kodutoo;
...
import com.example.cerx.kodutoo.R;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, Nimed);
    ...
    public void add(View view) {
        Nimed.add(txt_firstname.getText().toString() +" "+ txt_lastname.getText().toString());
        adapter.notifyDataSetChanged();
        txt_firstname.setText("");
        txt_lastname.setText("");
    }
